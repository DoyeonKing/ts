...
public class PerformanceService {
    ...
    public String initSeedData() {
        ...
        createPerformance(1L, 23L, "国家大剧院", "北京",
    ...
    private void createPerformance(Long playId, Long venueId, String venueName, String city,
