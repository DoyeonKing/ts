...
<style scoped>
.node{position:absolute;border-radius:999rpx;display:flex;align-items:center;justify-content:center;border:2rpx solid rgba(255,255,255,.92);box-shadow:0 0 24rpx rgba(255,255,255,.22);z-index:6;transition:opacity .16s ease,transform .16s ease}
.selected{transform:scale(1.08);box-shadow:0 0 30rpx rgba(255,248,231,.5);z-index:8}
.faded{opacity:.34}
.node-text{font-size:18rpx;color:#fffef7;font-weight:700}
</style>
